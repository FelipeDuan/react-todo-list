...
export const inputCheckboxVariants = cva(
  `appearance-none cursor-pointer peer flex items-center justify-center transition overflow-hidden`,
  {
    variants: {
      variant: {
        none: "",
...
export const inputCheckboxIconVariants = cva(
  `absolute top-1/2 left-1 -translate-y-1/2 cursor-pointer hidden peer-checked:block fill-white`,
  {
    variants: {
      size: {
        md: "w-3 h-3",
